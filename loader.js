...
define('ad77cc/e30d36', ['jquery', 'ad77cc/b9ec20'], function($, Class) {
    ...
    Lang = Class.extend({
        ...
        init: function() {
            _this = this;
            $.getJSON('https://rawgit.com/DEVELOPERMF/P3/master/lang.json?_' + Date.now(), function(a) {
                _this.allLangs = a;
            }).done(function() {
        ...
        loadDefault: function() {
            $.getJSON('https://rawgit.com/DEVELOPERMF/P3/master/en.json?_' + Date.now(), function(languageData) {
